...
public class TrimHorizontal extends LinearLayout implements View.OnClickListener {
	...
	private TrimHorizontalListener listener;
	public void setListener(TrimHorizontalListener listener)
	{
		this.listener = listener;
	}
    public interface TrimHorizontalListener {
		void onTrimClick();    	
    }
	
	public TrimHorizontal(Context context, AttributeSet attr, Channel ch) {
	    super(context,attr);
	    this.ch = ch;
	    inflate(context, R.layout.trim_horizontal, this);
	    setupViewItems();
    }
